...
<Recipe {...recipe}>
  ...
  <div slot="notes">
    <p>
      ...
      <a href="https://www.youtube.com/watch?v=RpOdennxP24">James Hoffman's
        video '<i>The Ultimate Clever Dripper Guide</i></a>.'
    </p>

    <p>It uses a ratio of 15g coffee to 250g water (1 to 16.67).</p>
  </div>
</Recipe>
